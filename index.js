...
module.exports.wheels = [
    ...
    {name: "Arctic Hunt", id: 0, weapon: 1, rarity: 1}, {
        ...
        keyW: "Sprays",
        seas: 4
    }, {name: "Cimota", creator: "Nxbulah", id: 225, free: !0, keyW: "Sprays", type: 4, opacity: .8}, {
        name: "Slymex",
        creator: "Nxbulah",
        id: 226,
        free: !0,
        ...
        type: 4,
        opacity: .8
    }, {name: "Mommys", id: 227, free: !0, keyW: "Sprays", type: 4, opacity: .8}, {
        name: "Agent Mastery",
        creator: "iSpy, Nxbulah",
        mid: 2,
        midT: 94,
        ...
        blackM: !0,
        funds: 1e4,
        reqT: "Level 100 Agent",
        req: function (e) {
            return e && e.stats && 1089e4 <= (e.stats.c8 || 0)
        }
    }, {
        name: "Void Odyssey",
        id: 307,
        ...
        keyW: "Melee",
        seas: 4
    }, {name: "Teds", id: 228, free: !0, keyW: "Sprays", type: 4, opacity: .9}
], module.exports.limited = [];
for (var i = [
    {mid: 0, scl: .9, mScl: 1, zOff: .28, yOff: -.5}, {
        mid: 0,
        noMuz: !0,
        spnScl: 1.3,
        scl: .9,
        ...
        zOff: 0,
        yOff: 0
    }, {flipAnim: !0, id: 3, type: 3, scl: 2.6, sclMlt: 1, yOff: -1, xOff: -1.5, sxRot: .3, sxOff: .35, szOff: -.25}
], s = [1, 2, 6, 7, 8], r = 0; r < module.exports.skins.length; r++) {
    if (module.exports.skins[r].index = r, null != module.exports.skins[r].template) {
        var o = i[module.exports.skins[r].template];
        for (var l in o) module.exports.skins[r][l] = o[l];
        delete module.exports.skins[r].template
    }
    module.exports.skins[r].type && -1 != s.indexOf(module.exports.skins[r].type) && (null == module.exports.skins[r].sitOff && (module.exports.skins[r].sitOff = 0), null == module.exports.skins[r].sitOffZ && (module.exports.skins[r].sitOffZ = 0), null == module.exports.skins[r].sclMlt && (module.exports.skins[r].sclMlt = 0)), (module.exports.skins[r].weapon || module.exports.skins[r].type && 3 == module.exports.skins[r].type) && (null == module.exports.skins[r].trans && (module.exports.skins[r].trans = !1), null == module.exports.skins[r].alpha && (module.exports.skins[r].alpha = 0), null == module.exports.skins[r].side && (module.exports.skins[r].side = 0), null == module.exports.skins[r].glow && (module.exports.skins[r].glow = !1), null == module.exports.skins[r].pulsT && (module.exports.skins[r].pulsT = 0)), module.exports.skins[r].free && (module.exports.skins[r].limT = "Free", module.exports.skins[r].noSale = !0, module.exports.skins[r].noSpin = !0), module.exports.skins[r].itemShop && (module.exports.skins[r].noSale = 1 == module.exports.skins[r].itemShop, module.exports.skins[r].noSpin = !0, module.exports.skins[r].limited = !0), module.exports.skins[r].drop && (module.exports.skins[r].noSale = !0, module.exports.skins[r].noSpin = !0, module.exports.skins[r].limited = !0, module.exports.skins[r].noQuickSell = !0, module.exports.skins[r].limT = "Twitch"), module.exports.skins[r].mapReward && (module.exports.skins[r].noSale = !0, module.exports.skins[r].noSpin = !0, module.exports.skins[r].noQuickSell = !0), module.exports.skins[r].thumbnail = n.getPreview(module.exports.skins[r], module.exports)
}
for (r = 0; r < module.exports.limited.length; r++) module.exports.limited[r].i = r
